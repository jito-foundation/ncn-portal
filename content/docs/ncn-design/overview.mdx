...
## On-Chain NCN Program
    ...
    - <a href="./on-chain-ncn/pricing" target="_blank">Pricing</a> - Define Supported Token and Weight of Supported Token
    - <a href="./on-chain-ncn/snapshot" target="_blank">Snapshot</a> - Taking snapshot of Vault, Operator, Operator Stake Weight
    - <a href="./on-chain-ncn/core-logic" target="_blank">Core Logic</a> - Define Consensus Mechanism
    - <a href="./on-chain-ncn/reward-payments" target="_blank">Reward Payments</a> - Define Reward Payments
